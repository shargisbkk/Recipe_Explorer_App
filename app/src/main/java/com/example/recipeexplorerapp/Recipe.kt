...
val sampleRecipes = listOf(
    ...
    Recipe(2, "Chicken Tikka Masala", "Creamy and flavorful Indian curry.", "Ingredients: Chicken, Yogurt, Lemon juice, Ginger, Garlic, Garam Masala, Turmeric, Cumin, Tomato puree, Cream. \n\nMethod: Marinate and grill chicken. Sauté aromatics, add spices and tomato. Stir in cream and chicken."),
